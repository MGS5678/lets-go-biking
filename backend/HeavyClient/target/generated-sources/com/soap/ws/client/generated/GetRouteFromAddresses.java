...
@XmlRootElement(name = "GetRouteFromAddresses")
public class GetRouteFromAddresses {

    @XmlElementRef(name = "address1", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> address1;
    @XmlElementRef(name = "address2", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
